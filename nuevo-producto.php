...
<head>
    ...
    <title>Nuevo Producto - Quesos Leslie</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
            ...
            <a href="nuevo-producto.php" class="nav-link active" style="padding-left: 40px;">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="nuevo-producto.php">
                            <div class="mb-3">
                                <label class="form-label">Nombre del Producto *</label>
                                <input type="text" class="form-control" name="nombre" required placeholder="Ej: Queso Gouda">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="precio_unitario" required min="0" step="0.01" placeholder="0.00">
                                </div>
                                
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Stock Inicial</label>
                                    <input type="number" class="form-control" name="stock_actual" min="0" value="0" placeholder="0">
                                </div>
                                
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Stock Mínimo *</label>
                                    <input type="number" class="form-control" name="stock_minimo" required min="0" value="10" placeholder="10">
                                </div>
                            </div>
                            ...
                            <div class="text-end">
                                <a href="inventario.php" class="btn btn-secondary me-2">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card kpi-card">
                    ...
                    <div class="kpi-value" style="color: var(--environment);">$45,680</div>
            ...
            <div class="col-md-3">
                <div class="card kpi-card">
                    <div class="kpi-label">Próximos a Caducar</div>
                    <div class="kpi-value" style="color: var(--warning);">5</div>
                    <div class="kpi-trend up">
                        <i class="fas fa-arrow-up"></i> 1 vs semana anterior
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="alert alert-expiring d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <strong>5 productos requieren atención inmediata</strong> - 3 con stock crítico y 2 próximos a caducar
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="user-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>15/11/2023 09:30</td>
                                    <td>Queso Gouda</td>
                                    <td>#PR-231101</td>
                                    <td><span class="badge-status status-critical">Salida</span></td>
                                    <td>-5 kg</td>
                                    <td>Ana Pérez</td>
                                    <td>Pedido #QL-231101</td>
                                </tr>
                                <tr>
                                    <td>15/11/2023 08:15</td>
                                    <td>Yogurt Natural</td>
                                    <td>#PR-231103</td>
                                    <td><span class="badge-status status-optimal">Entrada</span></td>
                                    <td>+20 L</td>
                                    <td>Carlos Rodríguez</td>
                                    <td>Producción #PR-231115</td>
                                </tr>
                                <tr>
                                    <td>14/11/2023 16:45</td>
                                    <td>Queso Manchego</td>
                                    <td>#PR-231102</td>
                                    <td><span class="badge-status status-critical">Salida</span></td>
                                    <td>-8 kg</td>
                                    <td>Luis Gómez</td>
                                    <td>Pedido #QL-231100</td>
                                </tr>
                                <tr>
                                    <td>14/11/2023 14:20</td>
                                    <td>Crema Fresca</td>
                                    <td>#PR-231104</td>
                                    <td><span class="badge-status status-optimal">Entrada</span></td>
                                    <td>+15 kg</td>
                                    <td>María González</td>
                                    <td>Producción #PR-231114</td>
                                </tr>
                                <tr>
                                    <td>14/11/2023 11:10</td>
                                    <td>Mantequilla</td>
                                    <td>#PR-231105</td>
                                    <td><span class="badge-status status-critical">Salida</span></td>
                                    <td>-3 kg</td>
                                    <td>Ana Pérez</td>
                                    <td>Venta #V-231105</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
