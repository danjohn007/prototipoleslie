...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo BASE_URL; ?>/administracion-financiera.html" class="nav-link">
                <i class="fas fa-dollar-sign"></i> Admin. Financiera
            </a>
            <a href="<?php echo BASE_URL; ?>/nueva-transaccion.html" class="nav-link" style="padding-left: 40px;">
