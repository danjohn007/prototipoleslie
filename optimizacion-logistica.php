...
$stats = $routeModel->getStats();
$recentRoutes = $routeModel->getRecent(10);
...
<head>
    ...
    <title>Optimización Logística - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1 class="page-title">Optimización Logística</h1>
            <div>
                <button class="btn btn-primary me-2">
                    <i class="fas fa-plus"></i> Nueva Ruta
                </button>
                <button class="btn btn-success">
                    <i class="fas fa-sync-alt"></i> Optimizar Rutas
                </button>
            </div>
        </div>
