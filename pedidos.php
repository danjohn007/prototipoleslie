...
<head>
    ...
    <title>Gestión de Pedidos - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div>
                <a href="nuevo-pedido.php" class="btn btn-primary me-2">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card kpi-card">
                    ...
                    <div class="kpi-value" style="color: var(--warning);"><?php echo $stats['pendientes'] ?? 0; ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card kpi-card">
                    <div class="kpi-label">En Preparación</div>
                    <div class="kpi-value" style="color: var(--human-rights);"><?php echo $stats['en_preparacion'] ?? 0; ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card kpi-card">
                    <div class="kpi-label">En Ruta</div>
                    <div class="kpi-value" style="color: var(--equity);"><?php echo $stats['en_ruta'] ?? 0; ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card kpi-card">
                    <div class="kpi-label">Entregados Hoy</div>
                    <div class="kpi-value" style="color: var(--environment);"><?php echo $stats['hoy'] ?? 0; ?></div>
                </div>
            </div>
        </div>
                                ...
                                <?php if (count($recentOrders) > 0): ?>
                                    <?php foreach ($recentOrders as $order): 
                                        ...
                                        switch($order['estado']) {
                                            ...
                                            case 'en_ruta': $statusClass = 'status-shipped'; break;
                                            case 'en_preparacion': $statusClass = 'status-preparing'; break;
                                            case 'confirmado': $statusClass = 'status-confirmed'; break;
                                            case 'pendiente': $statusClass = 'status-pending'; break;
                                            case 'cancelado': $statusClass = 'status-cancelled'; break;
                                            default: $statusClass = 'status-pending';
                                        }
                                        $estadoTexto = ucfirst(str_replace('_', ' ', $order['estado']));
                                    ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($order['numero_pedido']); ?></td>
                                    <td><?php echo htmlspecialchars($order['cliente_nombre']); ?></td>
                                    <td>
                                        <?php
                                        // Get order details
                                        $details = $orderModel->getDetails($order['id']);
                                        if ($details) {
                                            foreach ($details as $detail) {
                                                echo '<span class="product-icon product-cheese"><i class="fas fa-cheese"></i></span> ';
                                                echo htmlspecialchars($detail['producto_nombre']) . ' (' . $detail['cantidad'] . ')<br>';
                                            }
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td><span class="badge-status <?php echo $statusClass; ?>"><?php echo $estadoTexto; ?></span></td>
                                    <td>
                                        ...
                                        <?php elseif ($order['estado'] == 'en_ruta'): ?>
